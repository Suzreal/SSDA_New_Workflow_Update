...
├── training_data.json -> sample scheme we want and example shown to the model
├── instructions.json -> instuction files
├── convert_gemini_json_improved.py -> convert archvault output to 'beautiful json' (optional)
